...
namespace BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Created,Description,FileName,FileData,FileType,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Created,Description,FileName,FileData,FileType,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
